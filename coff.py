...
.user-box{align-self:flex-end;background:#4E342E;color:#f5e6d3;padding:12px 16px;border-radius:18px;max-width:70%;font-size:15px;margin-bottom:6px;}
.bot-box{align-self:flex-start;background:#5D4037;color:#f5e6d3;padding:12px 16px;border-radius:18px;max-width:70%;font-size:15px;margin-bottom:6px;}

.typing-box{align-self:flex-start;background:#4a332b;color:#f5e6d3;padding:10px 14px;border-radius:18px;max-width:70%;font-size:14px;display:flex;align-items:center;gap:8px;opacity:0.9;}
...
if query:
    live_user = st.empty()
    live_user.markdown(f'<div class="user-box">{query}</div>', unsafe_allow_html=True)
...
for item in st.session_state.chat_history:
    ...
    st.markdown(f'<div class="user-box">{q}</div>', unsafe_allow_html=True)
    st.markdown(f'<div class="bot-box">{a}</div>', unsafe_allow_html=True)
